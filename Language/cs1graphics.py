...
Copyright 2008-2013, David Letscher and Michael H. Goldwasser

Go to www.cs1graphics.org for more information.

This is Version 1.2a3 alpha release (30 January 2013)
"""
...
class _GraphicsManager:
    ...
    def _createRendered(self, chain, properties):
        ...
        rendered = mapping.get(chain[-1][1])
        if _debug >= 1: print('_createRendered called on chain' + str(chain) + ' using ' + str(rendered))
...
class _GraphicsContainer(object):
    ...
    def add(self, drawable):
        ...
        if self in _graphicsManager._frontHierarchy:
            ...
            cls = type(self)    # had been Canvas if isinstance(self, Canvas) else Layer
    ...
    def remove(self, drawable):
        ...
        if drawable in _graphicsManager._frontHierarchy:
            cls = type(self)          #  was: Canvas if isinstance(self, Canvas) else Layer
            _graphicsManager.beginRefresh()
